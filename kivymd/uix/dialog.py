    ...
    BoxLayout:
        ...
        ScrollView:
            ...
            MDList:
                ...
                ThinBox:
                    ThinLabel:
                        text: "Навигационные системы: "
                    ThinLabel:
                        text: root.Organic
                ThinBox:
                    ThinLabel:
                        text: "Системы информирования: "
                    ThinLabel:
                        text: root.Bakedgoods
                ThinBox:
                    ThinLabel:
                        text: "Системы тифлокомментирования: "
                    ThinLabel:
                        text: root.Cheese
                ThinBox:
                    ThinLabel:
                        text: "Системы субтитрирования: "
                    ThinLabel:
                        text: root.Crafts
                ThinBox:
                    ThinLabel:
                ...
                ThinBox:
                    ThinLabel:
                        text: "Перила и поручни: "
                    ThinLabel:
                        text: root.Eggs
                ThinBox:
                    ThinLabel:
                        text: "Подъемники для инвалидов: "
                    ThinLabel:
                        text: root.Seafood
                ThinBox:
                    ThinLabel:
                        text: "Прокат инвалидных колясок: "
                    ThinLabel:
                        text: root.Herbs
                ThinBox:
                    ThinLabel:
                        text: "Система вызова помощника: "
                    ThinLabel:
                        text: root.Vegetables
                ThinBox:
                    ThinLabel:
                        text: "Электронные табло: "
                    ThinLabel:
                        text: root.Honey
                ThinBox:
                    ThinLabel:
                        text: "Информационные терминалы: "
                    ThinLabel:
                        text: root.Jams
                ThinBox:
                    ThinLabel:
                        text: "Системы электронной очереди: "
                    ThinLabel:
                        text: root.Maple
                ThinBox:
                    ThinLabel:
                        text: "Тактильно-визуальные знаки: "
                    ThinLabel:
                        text: root.Meat
                ThinBox:
                    ThinLabel:
                        text: "Контрастные полосы : "
                    ThinLabel:
                        text: root.Nursery
                ThinBox:
                    ThinLabel:
                        text: "Противоскользящие покрытия: "
                    ThinLabel:
                        text: root.Nuts
                ThinBox:
                    ThinLabel:
                        text: "Информационные настенные стенды: "
                    ThinLabel:
                        text: root.Plants
                ThinBox:
                    ThinLabel:
                        text: "Системы автоматического открывания дверей: "
                    ThinLabel:
                        text: root.Poultry
                ThinBox:
                    ThinLabel:
                        text: "Поручни в санитарно-гигиенических комнат: "
                    ThinLabel:
                        text: root.Prepared
                ThinBox:
                    ThinLabel:
                        text: "Сантехника для инвалидов: "
                    ThinLabel:
                        text: root.Soap
                ThinBox:
                    ThinLabel:
                ...
                ThinBox:
                    ThinLabel:
                        text: "Телефоны с крупными кнопками: "
                    ThinLabel:
                        text: root.Wine
                ThinBox:
                    ThinLabel:
                        text: "Средства эвакуации: "
                    ThinLabel:
                        text: root.Coffee
                ThinBox:
                    ThinLabel:
                        text: "Акустические системы: "
                    ThinLabel:
                        text: root.Beans
                ThinBox:
                    ThinLabel:
                        text: "Индивидуальный транспорт: "
                    ThinLabel:
                        text: root.Fruits
        MDSeparator:
            id: sep
...
class ListMDDialog(BaseDialog):
    FMID = StringProperty("Missing data")
